    ...
    <div className="min-h-screen pb-48">
      ...
      {loading ? (
        ...
        <main className="space-y-6 px-4 pt-5">
          ...
          <section>
            <SectionTitle>Класс износа</SectionTitle>
            <div className="flex flex-wrap gap-2">
          ...
          {/* Narx tartibi */}
          <section>
            <SectionTitle>Сортировка по цене</SectionTitle>
            <div className="flex gap-2">
              <button
              ...
              >
                <ArrowUpNarrowWide size={13} /> Сначала дешевле
              </button>
              <button
              ...
              >
                <ArrowDownNarrowWide size={13} /> Сначала дороже
              </button>
            </div>
          </section>
        </main>
